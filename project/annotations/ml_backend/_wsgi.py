...
if __name__ == "__main__":
    ...
    if args.check:
        print('Check "' + PoseEstimationModel.__name__ + '" instance creation..')
        model = PoseEstimationModel(**kwargs)

    app = init_app(model_class=PoseEstimationModel, basic_auth_user=args.basic_auth_user, basic_auth_pass=args.basic_auth_pass)

    app.run(host=args.host, port=args.port, debug=args.debug)

else:
    # for uWSGI use
    app = init_app(model_class=PoseEstimationModel)
