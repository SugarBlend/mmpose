...
class StagewiseNoDecayNormConstructor(DefaultOptimWrapperConstructor):
    def add_params(self,
                   params: List[dict],
                   module: nn.Module,
                   prefix: str = '',
        ...
        for name, param in module.named_parameters(recurse=False):
            ...
            for key in sorted_keys:
                if key in f'{prefix}.{name}':
                    # Exclude normalization layers which will be changed with 'norm_decay_mult' param
                    if is_norm or is_dcn_module:
                        break
